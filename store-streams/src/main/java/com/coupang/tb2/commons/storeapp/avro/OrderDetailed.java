 ...
 */
package com.coupang.tb2.commons.storeapp.avro;
...
public class OrderDetailed extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderDetailed\",\"namespace\":\"com.coupang.tb2.commons.storeapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"org.apache.kafka.connect.data.Timestamp\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"payment_type\",\"type\":\"string\"},{\"name\":\"status\",\"type\":\"string\"},{\"name\":\"customer_id\",\"type\":\"long\"},{\"name\":\"customer_name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"products\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"ProductDetail\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"},{\"name\":\"unit\",\"type\":\"int\"}],\"connect.name\":\"com.coupang.tb2.commons.storeapp.avro.ProductDetail\"}},\"default\":[]}],\"connect.name\":\"com.coupang.tb2.commons.storeapp.avro.OrderDetailed\"}");
...
static {
  ...
  public static OrderDetailed fromByteBuffer(
   ...
   private java.util.List<ProductDetail> products;
   ...
   */
  public OrderDetailed(java.lang.CharSequence id, java.time.Instant created_at, java.lang.CharSequence payment_type, java.lang.CharSequence status, java.lang.Long customer_id, java.lang.CharSequence customer_name, java.util.List<ProductDetail> products) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: products = (java.util.List<ProductDetail>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<ProductDetail> value) {
    this.products = value;
  }
   ...
   */
  public static OrderDetailed.Builder newBuilder() {
    return new OrderDetailed.Builder();
  }
   ...
   * @return A new OrderDetailed RecordBuilder
   */
  public static OrderDetailed.Builder newBuilder(OrderDetailed.Builder other) {
    if (other == null) {
      return new OrderDetailed.Builder();
    } else {
      return new OrderDetailed.Builder(other);
    }
  }
   ...
   * @return A new OrderDetailed RecordBuilder
   */
  public static OrderDetailed.Builder newBuilder(OrderDetailed other) {
    if (other == null) {
      return new OrderDetailed.Builder();
    } else {
      return new OrderDetailed.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderDetailed>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(OrderDetailed.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(OrderDetailed other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setPaymentType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearPaymentType() {
      payment_type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearCustomerId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearCustomerName() {
      customer_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder setProducts(java.util.List<ProductDetail> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderDetailed.Builder clearProducts() {
      products = null;
    ...
    public OrderDetailed build() {
      try {
        ...
        record.products = fieldSetFlags()[6] ? this.products : (java.util.List<ProductDetail>) defaultValue(fields()[6]);
        return record;
