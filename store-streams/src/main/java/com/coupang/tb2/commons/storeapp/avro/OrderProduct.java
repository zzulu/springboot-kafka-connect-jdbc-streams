...
public class OrderProduct extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderProduct\",\"namespace\":\"com.coupang.tb2.commons.storeapp.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":\"string\"},{\"name\":\"product_id\",\"type\":\"long\"},{\"name\":\"unit\",\"type\":\"int\"}],\"connect.name\":\"com.coupang.tb2.commons.storeapp.avro.OrderProduct\"}");
   ...
   */
  public static OrderProduct.Builder newBuilder() {
   ...
   * @return A new OrderProduct RecordBuilder
   */
  public static OrderProduct.Builder newBuilder(OrderProduct.Builder other) {
    if (other == null) {
      return new OrderProduct.Builder();
    } else {
      return new OrderProduct.Builder(other);
    }
  }
   ...
   * @return A new OrderProduct RecordBuilder
   */
  public static OrderProduct.Builder newBuilder(OrderProduct other) {
    if (other == null) {
      return new OrderProduct.Builder();
    } else {
      return new OrderProduct.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderProduct>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(OrderProduct.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(OrderProduct other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder setProductId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder setUnit(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public OrderProduct.Builder clearUnit() {
