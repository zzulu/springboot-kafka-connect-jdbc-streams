...
public class ProductDetail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5849586857392833530L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductDetail\",\"namespace\":\"com.coupang.tb2.commons.storeapp.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"string\"},{\"name\":\"unit\",\"type\":\"int\"}],\"connect.name\":\"com.coupang.tb2.commons.storeapp.avro.ProductDetail\"}");
   ...
   * @return A new ProductDetail RecordBuilder
   */
  public static ProductDetail.Builder newBuilder(ProductDetail.Builder other) {
    if (other == null) {
      return new ProductDetail.Builder();
    } else {
      return new ProductDetail.Builder(other);
    }
  }
   ...
   * @return A new ProductDetail RecordBuilder
   */
  public static ProductDetail.Builder newBuilder(ProductDetail other) {
    if (other == null) {
      return new ProductDetail.Builder();
    } else {
      return new ProductDetail.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductDetail>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ProductDetail.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ProductDetail other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder setPrice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder setUnit(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ProductDetail.Builder clearUnit() {
